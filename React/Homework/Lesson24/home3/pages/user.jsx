      ...
      return(
            <ul className="list-group">
               {this.props.users.map(function(user, index) {
                  return <ResultItem key={user.id} name={user.first_name} lastName={user.last_name} Id={user.id} email={user.email} gender={user.gender} addr={user.ip_address}>1</ResultItem>
               })}
            </ul>
      )}
})
